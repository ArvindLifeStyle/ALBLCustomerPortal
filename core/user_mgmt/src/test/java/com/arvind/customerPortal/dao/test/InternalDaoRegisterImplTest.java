...
public class InternalDaoRegisterImplTest {
	@InjectMocks
	private InternalRegisterDaoImpl internalRegisterDaoImpl;
	...
	public void setUp(){
		...
		ReflectionTestUtils.setField(internalRegisterDaoImpl, "encrypt", encrypt);
		ReflectionTestUtils.setField(internalRegisterDaoImpl, "userPersist", userPersist);
		ReflectionTestUtils.setField(internalRegisterDaoImpl, "entityManager", entityManager);
		ReflectionTestUtils.setField(internalRegisterDaoImpl, "env", env);
